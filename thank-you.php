<?php
session_start();
// Get the Order ID and Payment ID from the URL
...
// Optionally, you can fetch more order details from the database here
// using the $order_id to show the customer more information.
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container">
    <div class="thankyou-container">
        ...
        <div class="order-details">
            ...
            <p><span>Order ID:</span> <strong><?php echo $order_id; ?></strong></p>
            <p><span>Payment ID:</span> <strong><?php echo $payment_id; ?></strong></p>
